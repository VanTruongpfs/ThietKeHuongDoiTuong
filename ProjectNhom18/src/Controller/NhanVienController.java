...
public class NhanVienController {
	...
	public void hienThiNV() {
		...
		for (NhanVien nv : list) {
			Object[] row = { nv.getMaNV(), nv.getTenNV(), nv.getNgaySinh(), nv.getNgayBDLam(), nv.getLuongCB(),
					nv.getSoGioLam() };
	...
	public void themNhanVien() {
		...
		if (maNV.isEmpty() || tenNV.isEmpty() || ngaySinhStr.isEmpty() || ngayBDLStr.isEmpty() || luongStr.isEmpty()
				|| gioLamStr.isEmpty()) {
	...
	public void hienThiChiTietSua(String maNV) {
		...
		btnCapNhat.addActionListener(e -> {
			capNhatNhanVien(maNV, tfTen.getText(), tfNgaySinh.getText(), tfNgayBDL.getText(), tfLuongCB.getText(),
					tfSoGioLam.getText());
			suaDialog.dispose();
		});
	...
	public void capNhatNhanVien(String maNV, String tenNV, String ngaySinhStr, String ngayBDLStr, String luongStr,
			String gioLamStr) {
		try {
			Date ngaySinh = Date.valueOf(ngaySinhStr);
			Date ngayBDL = Date.valueOf(ngayBDLStr);
